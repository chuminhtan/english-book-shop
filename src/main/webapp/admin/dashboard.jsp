<jsp:include page="admin-header.jsp" />
        ...
        <!-- TITLE -->
        <h2 class="text-success font-weight-bold text-uppercase text-center my-4">Dashboard</h2>
        <!-- QUICK ACTIONS -->
        <div class="jumbotron">
            ...
            <div>
                ...
                <a href="#" class="btn btn-success">New Customer</a>
            </div>
        </div>
        <!-- END QUICK ACTIONS -->
        ...
        <div class="jumbotron">
            ...
            <div class="d-flex justify-content-lg-between">
                <span>Total Users: 12</span>
                <span>Total Books: 12</span>
                <span>Total Customers: 12</span>
                <span>Total Reviews: 12</span>
                <span>Total Orders: 12</span>
            </div>
        </div>
        <!-- END STATICTIS -->
